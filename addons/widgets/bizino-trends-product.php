...
class Bizino_Trends_Products_Widget extends Widget_Base{
	...
	public function get_name() {
		return 'bizinotrendproduct';
	}

	public function get_title() {
		return __( 'Bizino Trends Products', 'bizino' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			'btn_link',
			[
				'label' 		=> esc_html__( 'Button Link', 'bizino' ),
		...
		$this->add_control(
			'trends',
			[
				'label' 		=> __( 'Trends Product', 'bizino' ),
        ...
        $this->add_control(
			'button_icon_color',
			[
				'label' 		=> __( 'Button Icon Color', 'bizino' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
        ...
        $this->add_control(
			...
			[
				'label' 		=> __( 'Button Icon hover Color', 'bizino' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
