!(function($) {
    ...
    $(window).on( 'elementor/frontend/init', function() {
        ...
        // Features
        elementorFrontend.hooks.addAction('frontend/element_ready/bizinofeatures.default',function($scope) {
        ...
        // Gallery
        elementorFrontend.hooks.addAction('frontend/element_ready/bizinogallery.default',function($scope) {
